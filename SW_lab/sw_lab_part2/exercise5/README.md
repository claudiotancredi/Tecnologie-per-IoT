## LAB Software Part 2 Esercizio 5

Codice sorgente contenente un server REST basato su [Cherrypy](https://cherrypy.org/)
con all'interno un [plugin](https://docs.cherrypy.org/en/latest/extend.html#plugins)
basato su [paho](https://github.com/eclipse/paho.mqtt.python) per permettere la comunicazione
con broker MQTT
...
```bash
$ cd SW_lab/sw_lab_part2/exercise5
...
e sulla porta 8080 ed il plugin MQTT collegato al broker: "test.mosquitto.org" alla porta 1883
e sottoscritto al topic **"catalog/devices"** per aggiungere devices tramite MQTT.
